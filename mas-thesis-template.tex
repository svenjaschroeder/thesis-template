...
\documentclass[fallstudie,grey,english]{mas-thesis}				% Verfügbare Optionen:
...
\supervisor{Univ.-Prof.~Dipl.-Ing.~Dr.~Betreuer~Name}		% ~ statt Leerzeichen für schönere Abstände
\reviewerA{Gutachter~A}
\reviewerB{Gutachter~B}
\degreecourse{Angewandte Informatik - Network Engineering}
\degree{Bachelor of Science}
\location{Essen}
\dateofthesis{\the\year}										% \today (ohne \the) ist auch eine Möglichkeit
